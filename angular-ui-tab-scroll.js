        ...
        return {
          ...
          template: [
            '<div class="ui-tabs-scrollable" ng-class="{\'show-drop-down\': !hideDropDown}">',
              ...
              ' tooltip-placement="{{tooltipLeftDirection}}" uib-tooltip-html="tooltipLeftHtml" tooltip-append-to-body="true">',
              ...
              ' tooltip-placement="{{tooltipRightDirection}}" uib-tooltip-html="tooltipRightHtml" tooltip-append-to-body="true">',
                ...
                '<ul class="dropdown-menu dropdown-menu-right" uib-dropdown-menu role="menu">',
                  '<li role="menuitem" ng-repeat="tab in dropdownTabs" ng-class="{\'disabled\': tab.disabled}" ng-click="activateTab(tab)">',
                    '<a href><span class="dropDownTabActiveMark" ',
                       'ng-style="{\'visibility\': tab.active?\'visible\':\'hidden\'}">',
                      '<i class="fa fa-check"></i></span>{{tab.tabScrollTitle}}',
                    '</a>',
                  '</li>',
                '</ul>',
              '</div>',
